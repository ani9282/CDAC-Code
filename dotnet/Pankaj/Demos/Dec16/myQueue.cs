...
public class myQueue
{
   ...
   { 	// Create and instantiate new queue
      ...
      Console.WriteLine("\tObject no \t0\t1\t2\t3");
			...
			Console.WriteLine();
			Console.WriteLine("Dequeue method removes and shows FIRST element from the queue FIRST ");
			Console.Write("The element removed is : " );
			Console.Write("\t{0}", myQueue.Dequeue());Console.WriteLine();
			// Show an element from the queue
			Console.WriteLine("\nPeek method just shows an element but does not remove it from the queue");
      ...
      Console.WriteLine();
      Console.WriteLine( "The target Array contains following elements BEFORE copying):" );
      PrintValues(myArray,' ');
      // Copy the entire source Stack to the target Array instance, starting at index 3.
      myQueue.CopyTo( myArray, 3 );
      Console.WriteLine();
      Console.WriteLine( "The target Array contains following elements AFTER copying):" );
      PrintValues(myArray,' ');
}
